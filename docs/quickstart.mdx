---
title: "Quickstart"
description: "Install Handler, connect to an A2A server, send your first message, and save a server configuration."
---
...
Point Handler at any A2A server you can reach. The examples below use
`http://localhost:8000` — substitute your own agent's URL.

Inspect the A2A server's agent card:
