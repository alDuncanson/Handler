...
Start or resume a conversation with the named server:
...
<Columns cols={2}>
  <Card title="Read the guides" icon="book-open" href="/guides/tui" cta="Explore workflows" arrow>
    Learn Handler's TUI, CLI messaging, server profiles, authentication, MCP,
